...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_form_wrapper', 'form-wrapper', 'margin' );
...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_form_wrapper', 'form-wrapper', 'padding' );
