...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_text_fields', 'text-fields', 'margin' );
...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_text_fields', 'text-fields', 'padding' );