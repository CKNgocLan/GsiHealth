...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_form_title_description', 'form-title', 
'margin' );
...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_form_title_description', 'form-title', 'padding' );