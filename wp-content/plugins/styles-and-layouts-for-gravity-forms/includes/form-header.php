...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_form_header', 'form-header', 'margin' );
...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_form_header', 'form-header', 'padding' );
