...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_submit_button', 'submit-button', 'margin' );
...
margin_padding_controls( $wp_customize, $current_form_id, 'gf_stla_form_id_submit_button', 'submit-button', 'padding' );
