...
class Section {
    ...
    function __construct(){
        ...
        // Add new controls
        add_action( 'elementor/element/section/section_custom_css_pro/after_section_end', array( $this, 'add_pseudo_background_controls' ), 20 );
        add_action( 'elementor/element/section/section_custom_css/after_section_end'    , array( $this, 'add_pseudo_background_controls' ), 20 );
     ...
     * @return void
     */
    public function add_pseudo_background_controls( $widget ){
