...
<head>
        ...
        <script src="//use.edgefonts.net/unifrakturmaguntia;ewert;monsieur-la-doulaise;herr-von-muellerhoff.js"></script>
<!-- outputs by wp_head -->
<?php wp_head();
// print_r(ADMIN_CSS_URL.'fonts/fontello/Bertholdr Mainzer Fraktur.ttf'); exit; ?>
<!-- end wp_head -->
</head>
